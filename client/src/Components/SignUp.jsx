...
class SignUp extends React.Component {
  ...
  postNewMentor(){
    ...
    axios
    .post("http://localhost:3033/api/Mentor", {firstName, lastName, skill, password,
    userName, email, bio})
    .then((res) => {
    ...
    render() {
      return (
        <div className="Team-A-signUp">
            ...
            <input type="checkbox" className="danielCheck" checked={this.state.mentiiCheck}></input>          
            <input type="checkbox" className="miyagiCheck" checked={this.state.mentorCheck}></input>
            ...
            <button type="submit" name="signUp" className="signUp" onClick={this.modalTurnOn} >Sign Up</button>
                      ...
                      <Modal.Body>
                       <Form>
                         <Form.Group controlId="formBasicFirstname" >
                           <Form.Control type="text" onChange={this.firstNameInput} placeholder="First Name" />
                               <Form.Text className="text-muted"></Form.Text>
                         </Form.Group>
                         <Form.Group controlId="formBasicLastname">
                           <Form.Control type="text" onChange={this.lastNameInput} placeholder="Last Name" />
                               <Form.Text className="text-muted"></Form.Text>
                         </Form.Group>
                         <Form.Group controlId="formBasicUserName">
                           <Form.Control type="text" onChange={this.userNameInput} placeholder="Username" />
                         </Form.Group>
                         <Form.Group controlId="formBasicPassword">
                            <Form.Control type="password" onChange={this.passwordInput} placeholder="Password" />
                         </Form.Group>
                         <Form.Group controlId="formBasicEmail">
                            <Form.Control type="email" onChange={this.emailInput} placeholder="Email" />
                         </Form.Group>
                         <Form.Group controlId="formBasicSkill">
                            <Form.Control type="text" onChange={this.skillInput} placeholder="Skill" />
                         </Form.Group>
                         <Form.Group controlId="formBasicBio">
                            <Form.Control type="text" onChange={this.bioInput} placeholder="Bio" />
                         </Form.Group>
                             <Button variant="primary" type="submit" onClick={this.signUpButton}> Sign Up </Button>
                        </Form>
                       </ Modal.Body>
                       </ Modal>
        </div>
